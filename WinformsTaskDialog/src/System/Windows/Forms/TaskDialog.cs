...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
                                                  ...
                                                  TaskDialogStartupLocation startupLocation)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    //BP IntPtr themingCookie = ThemingScope.Activate(Application.UseVisualStyles);
                    var useVisualStyles = Application.VisualStyleState != VisualStyles.VisualStyleState.NoneEnabled;
                    IntPtr themingCookie = ThemingScope.Activate(useVisualStyles);
                    HRESULT returnValue;
                    int resultButtonID;
                    try
                    {
        ...
        private bool CanCatchCallbackException()
        {
            ...
            // was thrown.
            //BP return !NativeWindow.WndProcShouldBeDebuggable;
            return !NativeWindowStub.WndProcShouldBeDebuggable;
        }
